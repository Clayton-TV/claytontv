    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[('GEN', 'Genesis'), ('EXO', 'Exodus'), ('LEV', 'Leviticus'), ('NUM', 'Numbers'),
                         ('DEU', 'Deuteronomy'), ('JOS', 'Joshua'), ('JUG', 'Judges'), ('RUT', 'Ruth'),
                         ('1SA', '1 Samuel'), ('2SA', '2 Samuel'), ('1KI', '1 Kings'), ('2KI', '2 Kings'),
                         ('1CH', '1 Chronicles'), ('2CH', '2 Chronicles'), ('EZR', 'Ezra'), ('NEH', 'Nehemiah'),
                         ('EST', 'Esther'), ('JOB', 'Job'), ('PSA', 'Psalms'), ('PRO', 'Proverbs'),
                         ('ECC', 'Ecclesiastes'), ('SOG', 'Song of Solomon'), ('ISA', 'Isaiah'), ('JER', 'Jeremiah'),
                         ...
                         ('REV', 'Revelation')], help_text='Three letter code related to each bible book.',
