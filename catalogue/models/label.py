...
class Label(models.Model):
    ...
    label_series = models.CharField(
        max_length=1000, help_text="Admin Label Related to the video's series."
    )
    label_subseries = models.CharField(
        max_length=1000, help_text="Admin Label Related to the video's subseries."
    )
    label_episode = models.CharField(
        max_length=1000, help_text="Admin Label Related to the video's episode."
    )
