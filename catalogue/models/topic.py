...
class Topic(models.Model):
    ...
    videos = models.ManyToManyField('Video', help_text="Select videos for this topic", related_name='+')
    series = models.ManyToManyField('Series', help_text="Select series for this topic", related_name='+')
