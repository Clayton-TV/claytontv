...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.imp_bible("CSV/Ministry.csv",options["DEBUG"]) #calls the function that imports the CSV at the file path into the Bible_Book data table. It also passes the result of options["DEBUG"] which checks if the debug command has been called.
