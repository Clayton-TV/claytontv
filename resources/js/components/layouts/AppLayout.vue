...
<template>
    <div class="flex min-h-full flex-col">
        <div class="sticky top-2 isolate z-10 mx-2 my-2 h-16">
            <Disclosure v-slot="{ open }" as="nav" class="mx-auto w-full max-w-6xl flex-none rounded-md bg-gray-900 shadow-2xl">
                <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
                    <div class="relative flex h-16 items-center justify-between">
                        <div class="flex items-center px-2 lg:px-0">
                            <Link href="/" class="flex items-center">
                                <LogoMark class="fill-primary size-8" />
                        ...
                        <div v-if="false" class="hidden lg:ml-4 lg:block">
                            <div class="flex items-center">
                                <button
                                    class="relative flex-shrink-0 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none"
                                    type="button"
                                >
                                ...
                                <Menu as="div" class="relative ml-4 flex-shrink-0">
                                    <div>
                                        <MenuButton
                                            class="relative flex rounded-full bg-gray-800 text-sm text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none"
                                        >
                                            <span class="absolute -inset-1.5" />
                ...
                <DisclosurePanel class="lg:hidden">
                    <div class="space-y-1 px-2 pt-2 pb-3">
                        <DisclosureButton
                            v-for="option in navOptions"
                            :key="option.name"
                            :class="isCurrent(option.href) ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'"
                            :href="option.href"
                            as="a"
                    ...
                    <div v-if="false" class="border-t border-gray-700 pt-4 pb-3">
                        <div class="flex items-center px-5">
                            ...
                            <button
                                class="relative ml-auto flex-shrink-0 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none"
                                type="button"
                            >
                                <span class="absolute -inset-1.5" />
                                <span class="sr-only">View notifications</span>
        ...
        <footer class="flex flex-col items-center gap-y-10 rounded-t-lg bg-gradient-to-b from-gray-800 to-gray-950 px-5 py-10">
            <div class="space-y-3">
                <p class="text-center text-xl font-bold text-balance">Want some occasional updates from us?</p>

                <form class="flex flex-col gap-y-2" @submit.prevent="subscribeToNewsletter">
                    <input
                        ...
                        type="email"
                    />
                    <button class="h-11 rounded bg-blue-500" type="submit">Subscribe</button>
                </form>
            </div>
            ...
            <div class="space-y-3 text-center">
                <div class="flex flex-col items-center">
                    <div class="flex items-center gap-x-2.5">
                        <LogoMark class="fill-primary size-10" />
                        <h1 class="text-3xl font-bold">Clayton TV</h1>
                    </div>
                    <p class="mt-1 text-sm text-gray-300">Your digital catalogue for Godly content.</p>
                </div>

                <div class="flex justify-center gap-x-3">
                    <div class="flex aspect-square w-12 items-center justify-center rounded-md bg-gray-800">
            ...
            <div>
                <p class="text-xs text-gray-400">&copy; {{ new Date().getFullYear() }} The Jesmond Trust. All rights reserved.</p>
            </div>
        </footer>
    </div>
</template>
