...
const categories = ref(['All', ...props.topics_data.map((t) => t.category).filter((item, index, array) => array.indexOf(item) == index)]);
...
const filteredSubCategories = computed(() => {
    const sortedSubCategories = [...subCategories.value].sort((a, b) => a.name.localeCompare(b.name));
