...
<template>
    <div class="flex h-full w-full rounded-md bg-gradient-to-br from-gray-700 to-gray-900">
        <LogoMark
        ...
        <div class="z-10 z-50 flex w-svw flex-col gap-y-1 place-self-end rounded-b-md bg-black/60 px-2.5 py-3.5 sm:px-3.5 sm:py-2">
            <h3 class="line-clamp-1 text-lg leading-snug font-bold text-white sm:text-2xl">
                {{ video.name }}
            </h3>
